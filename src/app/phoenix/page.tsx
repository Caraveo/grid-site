...
const downloads = [
  {
    ...
    href: `${releaseBase}/Phoenix-macOS-arm64.zip`,
    primary: true,
  },
  {
    platform: "macOS",
    format: "Intel",
    detail: "Native SwiftUI · macOS 13+ · light + dark",
    href: `${releaseBase}/Phoenix-macOS-x86_64.zip`,
  },
  {
    platform: "Windows",
    format: "Installer",
    detail: "Windows 10/11 · x86_64 · desktop app",
    href: `${releaseBase}/Phoenix-Windows-x86_64-setup.exe`,
    primary: true,
  },
  {
    platform: "Windows",
    ...
    href: `${releaseBase}/Phoenix-Windows-x86_64.msi`,
  },
  {
    platform: "Linux",
    format: "AppImage",
    detail: "Portable · x86_64",
    href: `${releaseBase}/Phoenix-Linux-x86_64.AppImage`,
    primary: true,
  },
  {
    platform: "Linux",
    ...
    href: `${releaseBase}/Phoenix-Linux-x86_64.deb`,
  },
];
...
export default function PhoenixWalletPage() {
  return (
    <main className="min-h-screen">
      ...
      <header className="hero-glow relative overflow-hidden px-5 pt-36 pb-20 sm:pt-44 sm:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-white/50 sm:text-xl">
            Phoenix brings the real GRID wallet workflow to a desktop interface: encrypted
      ...
      <Section id="downloads">
        <div className="mb-12 max-w-2xl">
          <p className="section-label">Phoenix desktop release · v0.2.28 preview</p>
      ...
      <Section className="text-center">
        ...
        <div className="mt-9 flex flex-wrap justify-center gap-3">
          <a href="#downloads" className="btn-primary">Download Phoenix</a>
