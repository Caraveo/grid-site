...
export const DOWNLOADS = {
  ...
  cli: {
    darwinX64:
      "/downloads/cli/v0.2.20/grid-darwin-x86_64",
    darwinArm64:
      "/downloads/cli/v0.2.20/grid-darwin-aarch64",
    linuxX64:
      "/downloads/cli/v0.2.20/grid-linux-x86_64" as string | null,
    windowsX64:
      "/downloads/cli/v0.2.20/grid-windows-x86_64.exe",
